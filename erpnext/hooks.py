app_name = "webmax"
app_title = "WEBMAX"
app_publisher = "WEBMAX Technologies"
app_description = """WEBMAX ERP made simple"""
app_icon = "fa fa-th"
app_color = "#2563eb"
app_email = "hello@webmax-erp.site"
app_license = "GNU General Public License (v3)"
source_link = "https://github.com/webmax/webmax"
app_logo_url = "/assets/webmax/images/webmax-logo.png"
app_home = "/desk"

add_to_apps_screen = [
	{
		"name": app_name,
		"logo": "/assets/webmax/images/webmax-logo.png",
		"title": app_title,
		"route": app_home,
		"has_permission": "webmax.check_app_permission",
	}
]

develop_version = "1.x.x-develop"

app_include_js = "webmax.bundle.js"
app_include_css = "webmax.bundle.css"
web_include_css = "webmax-web.bundle.css"
email_css = "email_webmax.bundle.css"

app_include_icons = [
	"/assets/webmax/icons/pos-icons.svg",
]
...
extend_doctype_class = {"Address": "webmax.accounts.custom.address.WEBMAXAddress"}

override_whitelisted_methods = {"frappe.www.contact.send_message": "webmax.templates.utils.send_message"}

welcome_email = "webmax.setup.utils.welcome_email"

# setup wizard
setup_wizard_requires = "assets/webmax/js/setup_wizard.js"
setup_wizard_stages = "webmax.setup.setup_wizard.setup_wizard.get_setup_stages"
setup_wizard_complete = "webmax.setup.setup_wizard.setup_wizard.setup_demo"
setup_wizard_test = "webmax.setup.setup_wizard.test_setup_wizard.run_setup_wizard_test"

after_install = "webmax.setup.install.after_install"

boot_session = "webmax.startup.boot.boot_session"
notification_config = "webmax.startup.notifications.get_notification_config"
get_help_messages = "webmax.utilities.activation.get_help_messages"
leaderboards = "webmax.startup.leaderboard.get_leaderboards"
filters_config = "webmax.startup.filters.get_filters_config"
additional_print_settings = "webmax.controllers.print_settings.get_print_settings"

on_session_creation = "webmax.portal.utils.create_customer_or_supplier"
...
jinja = {
	"methods": [
		"webmax.stock.serial_batch_bundle.get_serial_or_batch_nos",
	],
}

# website
webform_list_context = "webmax.controllers.website_list_for_contact.get_webform_list_context"
...
website_context = {
	"favicon": "/assets/webmax/images/webmax-favicon.png",
	"splash_image": "/assets/webmax/images/webmax-logo.png",
}
...
sounds = [
	{"name": "incoming-call", "src": "/assets/webmax/sounds/incoming-call.mp3", "volume": 0.2},
	{"name": "call-disconnect", "src": "/assets/webmax/sounds/call-disconnect.mp3", "volume": 0.2},
	{"name": "numpad-touch", "src": "/assets/webmax/sounds/numpad-touch.mp3", "volume": 0.8},
]
...
email_brand_image = "assets/webmax/images/webmax-logo.png"

default_mail_footer = """
	<span>
		مرسل عبر
		<a class="text-muted" href="https://webmax-erp.site?source=via_email_footer" target="_blank">
			WEBMAX
		</a>
	</span>
"""
